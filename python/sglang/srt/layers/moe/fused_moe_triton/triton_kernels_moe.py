...
except ImportError:  # triton_kernels >= 3.6 moved these into matmul_ogs
    from triton_kernels.matmul_ogs import GatherIndx, RoutingData, ScatterIndx

from triton_kernels.swiglu import swiglu_fn

# triton_kernels 3.6 moved the activation's reduction factor out of
# FusedActivation's third positional argument into FnSpecs(reduction_n=...).
_FNSPECS_HAS_REDUCTION_N = any(f.name == "reduction_n" for f in fields(FnSpecs))
